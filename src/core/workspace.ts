...
export function workspacePaths(projectRoot: string) {
  ...
  return {
    ...
    modelRoles: path.join(projectRoot, ".godotcoder.local", "model-roles.json"),
    modelRolesExample: path.join(projectRoot, ".godotcoder.local", "model-roles.example.json"),
    ...
    modelRunsDir: path.join(workspaceRoot, "model-runs"),
