...
export const sessionCommands: SessionCommand[] = [
  ...
  { name: "/harness", aliases: ["/run"], handler: "harness", description: "Run multi-agent workflow", flags: ["--apply", "--json", "--llm", "--repair"] },
  { name: "/pipeline", aliases: ["/make"], handler: "pipeline", description: "Build playable slice", flags: ["--preview", "--llm", "--model", "--play", "--json", "--no-validate", "--no-repair"] },
  ...
  { name: "/validate", aliases: ["/check"], handler: "validate", description: "Validate project", flags: ["--json", "--smoke", "--export"] },
  ...
  { name: "/build", handler: "build", description: "Build game feature", flags: ["--llm", "--preview", "--apply", "--yes", "--no-validate"] },
