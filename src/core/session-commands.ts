...
export const sessionCommands: SessionCommand[] = [
  ...
  { name: "/harness", aliases: ["/run"], handler: "harness", description: "Run multi-agent workflow", flags: ["--apply", "--json", "--repair"] },
  { name: "/pipeline", aliases: ["/make"], handler: "pipeline", description: "Build playable slice", flags: ["--preview", "--play", "--json", "--no-validate", "--no-repair"] },
  ...
  { name: "/build", handler: "build", description: "Build game feature", flags: ["--preview", "--apply", "--yes", "--no-validate"] },
