...
export const sessionCommands: SessionCommand[] = [
  ...
  { name: "/play", aliases: ["/open"], handler: "play", description: "Launch Godot game", flags: ["--editor", "--test", "--playtest", "--suggest-tasks", "--apply", "--json"] },
  { name: "/playtest", handler: "playtest", description: "Run automated playtest", flags: ["feedback", "--suggest-tasks", "--apply", "--json"] },
