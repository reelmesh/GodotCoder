...
- RPC-style JSON command for editor integration prep: `workspace.status`, `project.inspect`, `runtime.doctor`, `validation.run`, `docs.search`, `build.preview`, `debug.current`, `editor.context`, and `editor.explain`.
