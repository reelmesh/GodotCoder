...
- Summaries action through `editor.summary`, showing latest validation, visual validation, repair, playtest feedback, and model quality artifacts.
...
15. Click `Summaries` and confirm latest validation, visual validation, repair, playtest feedback, and model quality summaries are shown when artifacts exist.
...
- Summary action displays latest validation, visual validation, repair, playtest feedback, and model quality artifacts without reading workspace files from GDScript.
